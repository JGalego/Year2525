...
There is a hidden way to go the other direction instead: **The Archive**, regressing through the real history of computation and media — modern web, skeuomorphism, Windows, the ZX Spectrum, System 7, DOS, mainframes, punch cards, Jacquard looms, Babbage, the abacus, clay tablets, knotted rope, memory palaces, language, fire, and pre-symbolic cognition. Find the year counter near the top of the page. Or try the Konami code.
...
- `index.html` — all forward-timeline and archive content
